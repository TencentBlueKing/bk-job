...
echo "BK_JOB_FILE_WORKER_WORKSPACE_OUTER_DIR=$BK_JOB_FILE_WORKER_WORKSPACE_OUTER_DIR"
mkdir -p "$BK_JOB_FILE_WORKER_WORKSPACE_OUTER_DIR"
chmod 777 "$BK_JOB_FILE_WORKER_WORKSPACE_OUTER_DIR"
ln -s "$BK_JOB_FILE_WORKER_WORKSPACE_DIR" "$BK_JOB_FILE_WORKER_WORKSPACE_OUTER_DIR"
